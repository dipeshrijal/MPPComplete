package lesson10.lecture.genericss.slideexplanation;
...
public class SlideExampleCode {
	...
	/*
	 * public static <T> T[] toArray(Collection<T> coll) { T[] arr = new
	 * T[coll.size()]; //compiler error int k = 0; for(T element : coll) arr[k++] =
	 * element; return arr; }
	 */
}
