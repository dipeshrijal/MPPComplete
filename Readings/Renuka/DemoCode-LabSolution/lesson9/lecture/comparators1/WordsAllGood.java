...
/**
 * Sorts words in descending order of length, using the comparing method of
 * Comparator. In goodSort1, the argument to comparing is a lambda; in
 * goodSort2, the argument to comparing is a method reference.
 * 
 */
