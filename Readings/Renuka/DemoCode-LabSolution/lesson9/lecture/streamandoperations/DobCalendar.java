...
public class DobCalendar {
	public static void main(String[] args) {
		// collectingAndThen - Adapts a Collector to perform an additional finishing
		// transformation
		Map<Month, String> dobCalendar = Person.persons().stream().collect(collectingAndThen(
				groupingBy(p -> p.getDob().getMonth(), mapping(Person::getName, joining(", "))), result -> {
					// Add missing months
