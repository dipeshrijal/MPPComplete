...
public class CollectIntoMapTest {
	public static void main(String[] args) {
		/*
		 * Collectors.toMap() accepts three parameters-> 1. Key Mapping Function, 2.
		 * Value Mapping Function 3. Merging of all keys in to a single entity, here
		 * gender is the key, it merge all male, merge all the female
		 */

		System.out.println("Highest Paid Male and Female");
		Map<Person.Gender, Person> highestEarnerByGender = Person.persons().stream().collect(Collectors.toMap(
				Person::getGender, Function.identity(), // Similar like (p) -> p,
