...
public class Reuse {
	private static final BiFunction<List<String>, String, Stream<String>> listStartsWith 
	        = (list, letter) -> list.stream().filter(
	...
	public List<String> listFriendsNamesStartingWithB() {
		return listStartsWith.apply(Folks.friends, "B").collect(
				Collectors.toList());
	}
	public static void main(String[] args) {
		Reuse r = new Reuse();
		System.out.println(r.countNumberFriendsStartingWithB());
		System.out.println(r.listFriendsNamesStartingWithB());
	}
}
